...
"test.gsDesign.k" <- function()
{
     ...
     checkException(gsDesign(k=24, test.type=3, msg="Checking for out-of-range variable value", silent=TRUE)) 
...
"test.gsDesign.alpha" <- function()
{
     ...
     checkException(gsDesign(alpha=0.5, test.type=2, msg="Checking for out-of-range variable value", silent=TRUE)) 
...
{
     checkException(gsDesign(astar="abc", msg="Checking for incorrect variable type", silent=TRUE)) 
