...
private slots:
    ...
    void designMapToQDoubleSpinBox(QwtCounter *dspin);
    ...
    void initialize1ParamSpending(QComboBox *combo, QwtCounter *param, gsDesign::Spending spending);
    void loadDesign();
    ...
    void on_dnDescCombo_currentIndexChanged(int );
    void on_dnDescCombo_editTextChanged(QString );
    void on_dnModeCombo_currentIndexChanged(QString );
    void on_dnModeCombo_currentIndexChanged(int );
    void on_dnNameCombo_currentIndexChanged(int );
    void on_dnNameCombo_editTextChanged(QString );
    void on_eptErrorDSpin_valueChanged();
    void on_eptIntervalsSpin_valueChanged(int );
    void on_eptPowerDSpin_valueChanged();
    void on_eptErrorHSlider_valueChanged();
    void on_eptPowerHSlider_valueChanged();
    ...
    void setSpendingPointsBounds(QwtCounter *dspin1, QwtCounter *dspin2);
    void setStatusTips();
    void setHelpTips();
    ...
    void updateDesignMapQDoubleSpinBox(QwtCounter *dspin);
