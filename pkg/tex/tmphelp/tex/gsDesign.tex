...
See details, \LinkA{Spending Functions}{Spending Functions}, manual and examples.
\item[\code{sfupar}] Real value, default is \eqn{-4}{} which is an O'Brien-Fleming-like conservative bound when used
...
alternate hypotheses. See \LinkA{Spending Functions}{Spending Functions} and manual for further details.
...
For \code{test.type=1}, output value is \code{NULL}. See \LinkA{Spending Functions}{Spending Functions} and manual.
...
\end{References}
\begin{SeeAlso}\relax
\LinkA{gsDesign-package}{gsDesign.Rdash.package}, \LinkA{Group Sequential Plots}{Group Sequential Plots}, \code{\LinkA{gsProbability}{gsProbability}}, 
\LinkA{Spending Functions}{Spending Functions}, \LinkA{Wang-Tsiatis Bounds}{Wang.Rdash.Tsiatis Bounds}
\end{SeeAlso}
\begin{Examples}
\begin{ExampleCode}
