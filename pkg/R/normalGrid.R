...
{    
    ...
    if (r < 1 || r > 80) 
    {
        return(list(z=NULL, wgts=NULL, errcode=1, errmsg="r must be from 1 to 80"))
    }
    ...
    {
        return(list(z=NULL, wgts=NULL, errcode=2, errmsg="bounds variable in normalGrid must be numeric and have length 2"))        
    }
