...
{	
    ...
    {
        return((x2 / n2 - x1 / n1 - delta0) / sqrt(V))
    }
    ...
    {   
        if (delta0 != 0)
        {
            return(list(n=n, n1=n / (ratio + 1), n2=ratio * n / (ratio + 1), 
                            sigma0=sigma0, sigma1=sigma1, p1=p1, p2=p2, delta0=delta0, 
                            p10=p10, p20=p20))            
        } 
        else
        {
            return(list(n=n, n1=n / (ratio + 1), n2=ratio * n / (ratio + 1), sigma0=sigma0, 
                            sigma1=sigma1, p1=p1, p2=p2, pbar=p))            
        }
    }
    else
    {
