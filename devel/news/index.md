...
- Futility and harm bounds can now be skipped independently at an
  analysis; skipping futility no longer also removes an active harm
  bound ([\#284](https://github.com/keaven/gsDesign/issues/284)).
...
- New vignette “Power Computation for Group Sequential Survival Designs”
  ([`vignette("gsSurvPower")`](https://keaven.github.io/gsDesign/devel/articles/gsSurvPower.md))
...
- Added
  ...
  [`gsSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  objects ([\#264](https://github.com/keaven/gsDesign/issues/264)).
- Added
...
- [`simBinomialSeasonalExact()`](https://keaven.github.io/gsDesign/devel/reference/simBinomialSeasonalExact.md)
  ...
  summaries ([\#264](https://github.com/keaven/gsDesign/issues/264)).
- [`simBinomialSeasonalExact()`](https://keaven.github.io/gsDesign/devel/reference/simBinomialSeasonalExact.md)
...
- [`nSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  and
  [`gsSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  now validate fixed survival timing inputs before enrollment periods
  are adjusted, giving a clear error when `R`/`gamma` imply accrual
  beyond `T - minfup` instead of failing later while assigning row names
...
- [`nSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  and
  [`gsSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  now use the requested survival sample size method when either `T` or
  `minfup` is `NULL`.
  [`gsSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
...
- New vignette “Selective bound testing at interim analyses”
  ([`vignette("SelectiveBoundTesting")`](https://keaven.github.io/gsDesign/devel/articles/SelectiveBoundTesting.md))
...
- Added vignette “Multi-season studies for rare events”
  ([`vignette("MultiSeasonRareEvents")`](https://keaven.github.io/gsDesign/devel/articles/MultiSeasonRareEvents.md))
...
- [`nSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  and
  [`gsSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  now incorporate Schoenfeld and Freedman methods for sample size and
  power for time-to-event studies with proportional hazards. This allows
...
- [`sfXG3()`](https://keaven.github.io/gsDesign/devel/reference/sfXG.md)
  now correctly reports its name as “Xi-Gallo, method 3” instead of
...
- [`nNormal()`](https://keaven.github.io/gsDesign/devel/reference/nNormal.md)
  now links to
  [`vignette("nNormal")`](https://keaven.github.io/gsDesign/devel/articles/nNormal.md)
...
- Added new vignette
  [`vignette("binomialTwoSample")`](https://keaven.github.io/gsDesign/devel/articles/binomialTwoSample.md)
...
- [`toInteger()`](https://keaven.github.io/gsDesign/devel/reference/toInteger.md)
  ...
  ([`?toInteger`](https://keaven.github.io/gsDesign/devel/reference/toInteger.md))
  and
  [`vignette("toInteger")`](https://keaven.github.io/gsDesign/devel/articles/toInteger.md)
  for details.
...
- The [`summary()`](https://rdrr.io/r/base/summary.html) method for
  ...
  no longer includes the redundant `none = 1` in its output
  ([@jdblischak](https://github.com/jdblischak),
...
- Implemented conditional error spending functions
  ...
  [`vignette("ConditionalErrorSpending")`](https://keaven.github.io/gsDesign/devel/articles/ConditionalErrorSpending.md)
...
- Add new vignette on conditional power and conditional error, see
  [`vignette("ConditionalPowerPlot")`](https://keaven.github.io/gsDesign/devel/articles/ConditionalPowerPlot.md)
...
- [`gsSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  and
  [`nSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
  have updated default values for `T` and `minfup` so that function
  calls with no arguments will run. Legacy code with `T` or `minfup` not
...
- Updated
  [`sfLDOF()`](https://keaven.github.io/gsDesign/devel/reference/sfLDOF.md)
  to generalize with rho parameter; still backwards compatible for
...
- Added `sfTrimmed` as likely preferred spending function approach to
  ...
  information. Updated
  [`help(sfTrimmed)`](https://keaven.github.io/gsDesign/devel/reference/sfSpecial.md)
...
- Added `sfGapped`, which is primarily intended to eliminate futility
  ...
  [`help(sfGapped)`](https://keaven.github.io/gsDesign/devel/reference/sfSpecial.md)
  for an example
- Added
