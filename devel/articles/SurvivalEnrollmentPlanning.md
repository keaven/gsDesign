...
can solve one component of this plan while deriving a powered group
sequential design.
...
|----|----|----|
| What event-driven design achieves target power? | [`gsSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md) | Solves the required sample size, enrollment, or follow-up component |
| What design achieves target power at specified calendar looks? | [`gsSurvCalendar()`](https://keaven.github.io/gsDesign/devel/reference/gsSurvCalendar.md) | Fixes calendar analysis times and solves the powered design |
| What power does a specified plan achieve under a scenario? | [`gsSurvPower()`](https://keaven.github.io/gsDesign/devel/reference/gsSurvPower.md) | Keeps supplied enrollment, failure, treatment-effect, and timing assumptions fixed |
