...
and group sequential designs using
...
Lachin and Foulkes (1986) method for sample size under a proportional
hazards model with piecewise constant enrollment, piecewise exponential
failure and dropout rates. Users may also be interested in the [Shiny
...
[`gsSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md)
for examples with a stratified population or piecewise exponential
failure.
...
[`nSurv()`](https://keaven.github.io/gsDesign/devel/reference/nSurv.md),
we transform the median time-to-event (\\m\\) to an exponential event
...
size using the
[`gsDesign::normalGrid()`](https://keaven.github.io/gsDesign/devel/reference/normalGrid.md)
