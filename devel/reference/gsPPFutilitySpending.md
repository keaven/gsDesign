...
- prior:
  ...
  theta scale. `wgts` gives nonnegative prior masses or density-weighted
...
[`gsPP()`](https://keaven.github.io/gsDesign/devel/reference/gsCP.md)
averages conditional power over the posterior effect distribution to
give the probability of future efficacy rejection. This is not the
posterior probability of a positive effect, observed-effect CP, or CP
H1. The prior is held fixed throughout calibration, but the posterior is
...
[`vignette("CPFutilitySpending")`](https://keaven.github.io/gsDesign/devel/articles/CPFutilitySpending.md)
