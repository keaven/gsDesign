...
Requires Chrome, Python 3 (or `python`), ImageMagick, Ghostscript,
`pdfcrop`, and `pngquant`.
...
Set `PYTHON_BIN` to override the Python executable used to encode the local
`file://` URL for Chrome.
