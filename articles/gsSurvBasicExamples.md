...
gsBoundSummary(x) |>
  ...
  lt_footnote(footnoteUS, where = "column", columns = 3) |>
  lt_footnote(footnoteLS, where = "column", columns = 4) |>
  lt_footnote(footnoteHR, where = "body", columns = 2, rows = c(3, 8, 13)) |>
  lt_footnote(footnoteM, where = "body", columns = 1, rows = c(4, 9, 14)) |>
  lt_footnote(footnote1, where = "body", columns = 2, rows = c(4, 5, 9, 10, 14, 15)) |>
  lt_footnote(footnote2, where = "body", columns = 2, rows = c(4, 9, 14))
```
...
gsBoundSummary(
  ...
  lt_footnote(
    ...
    where = "body", columns = 3, rows = c(2, 5, 8)
  ) |>
  lt_footnote(
    "Interim futility guidance based on observed HR is non-binding.",
    where = "body", columns = 4, rows = c(3, 6)
  ) |>
  lt_footnote(
