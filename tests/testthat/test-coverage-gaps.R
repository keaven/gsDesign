testthat::test_that("nameperiod formats single and multiple periods", {
  expect_equal(nameperiod(3), "0-3")
  expect_equal(nameperiod(c(1, 2, 3)), c("0-1", "1-2", "2-3"))
})

testthat::test_that("periods builds period endpoints and names", {
...
testthat::test_that("eEvents1 returns detailed output when simple = FALSE", {
  res <- eEvents1(
...
testthat::test_that("KT and KTZ validate inputs and return numeric results", {
  expect_error(
...
testthat::test_that("LFPWE validates method constraints", {
  expect_error(
...
testthat::test_that("gsnSurv scales outputs based on variable type", {
...
testthat::test_that("LFPWE runs across supported methods", {
...
testthat::test_that("KTZ and KT cover additional branches", {
...
testthat::test_that("nEventsIA and print methods are exercised", {
