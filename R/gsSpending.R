...
# based on Xi and Gallo, 2019;38:4656-4669
...
#' @description Xi and Gallo (2018) first published the method of using spending functions 
#' to set boundaries for group sequential trials. In this publication they
#' proposed two specific spending functions: one to approximate an
#' O'Brien-Fleming design and the other to approximate a Pocock design.
#' The spending function to approximate O'Brien-Fleming has been generalized as proposed by Liu, et al (2012)
...
#' @keywords design
#' @rdname sfLDOF
#' @exportsfXG <- function(alpha, t, param) {
  if (param < 1 - pnorm(qnorm(1 - alpha / 2) / 2) | param >= 1) {
    stop(paste0("param should be between (",
    ...
    x <- list(name = "Xi-Gallo", param = param, 
              parname = "gamma", sf = sfXG, 
              spend = y,
              bound = NULL,
              prob = NULL)
    class(x) <- "spendfn"
