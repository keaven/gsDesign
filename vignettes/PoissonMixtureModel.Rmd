...
Due to this as well as substantial variability in event accrual caused by feasible differences in event rates and treatment effect, we use a calendar-based timing of analyses and calendar-based spending (@LanDeMets1989).
