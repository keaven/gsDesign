...
@xi2019additive proposed conditional error spending functions for group sequential designs are implemented in the `gsDesign` package. These may prove useful to some trial designers. Results duplicated findings from the original paper.
