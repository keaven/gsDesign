...
For post-design power sensitivity calculations, see the vignette *Power Computation for Group Sequential Survival Designs* for `gsSurvPower()`.
For a SAS PROC SEQDESIGN translation example, see the vignette *Reproducing SAS PROC SEQDESIGN survival designs in gsDesign*.
