...
[`VEtable`](https://keaven.github.io/gsDesign/reference/VEtable.md). For
\`test.type = 6\`, the exact object's upper event-count bound represents
the non-binding lower stopping bound, with its first probability column
